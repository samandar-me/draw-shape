...
import com.sdk.drawshape.local.dataStore
import com.sdk.drawshape.local.isDarkThemeOn
import com.sdk.drawshape.local.themePreferenceKey
...
@Composable
fun DrawShapeTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
